...
void CLK_DisableCKO(void)
{
    ...
    CLK_DisableModuleClock(((0x0<<31)|(0x3<<29) |(0x3<<25) |( 2<<20) |(0x0<<10) |6));
}
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    CLK_EnableModuleClock(((0x0<<31)|(0x3<<29) |(0x3<<25) |( 2<<20) |(0x0<<10) |6));

     
    CLK_SetModuleClock(((0x0<<31)|(0x3<<29) |(0x3<<25) |( 2<<20) |(0x0<<10) |6), u32ClkSrc, 0);
}
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if(u32PllClkSrc == 0x00000000UL)
    {
        ...
        ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON &= ~(1ul << 19);
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON & ~((0x1FFul << 0) | (0x1Ful << 9) | (3ul << 14))) | u32PLLReg;

    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON &= ~((1ul << 16) | (1ul << 18));

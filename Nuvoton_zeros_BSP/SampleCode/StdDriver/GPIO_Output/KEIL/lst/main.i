...
#line 105 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 106 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 6479 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 6536 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 6592 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"

#line 6599 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 6645 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 6663 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 163 "..\\..\\..\\..\\Library\\StdDriver\\inc\\clk.h"
...
#line 6664 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
#line 231 "..\\..\\..\\..\\Library\\StdDriver\\inc\\adc.h"
...
#line 261 "..\\..\\..\\..\\Library\\StdDriver\\inc\\adc.h"
...
#line 6665 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M051Series\\Include\\M051Series.h"
...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((0x0<<31)|(0x1<<29) |(0x3<<25) |(24<<20) |(0x0<<18) |(0x0F<<10) |( 8<<5) |16), 0x01000000UL, (((1)-1) << 8));
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P3_MFP |= (0x00000001UL | 0x00000002UL);
		...
		((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->OFFD |= ((0x01)<<16));
		 
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P1_MFP &= ~(0x00000101UL );
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P1_MFP |= 0x00000001UL ;
...
void seven_seg_show( uint8_t Digital)
{
	...
	{
		case 9:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x0F));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 8:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x00));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 7:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0xCF));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 6:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x13));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 5:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x1B));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 4:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x2F));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 3:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x4B));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 2:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x43));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0xFF));
			break;
		case 1:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0xEF));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
		case 0:
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->DOUT = (0x83));
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DOUT = (0x7F));
			break;
	}	
...
int main(void)
{
    ...
    UART0_Init();
		...
		ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<10), (0UL<<2), 0x01);
	...
	while(1)
	{
		...
		light_v = (((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(0)] & (0xFFFFul << 0))>>0);
		printf("%0000d \n",light_v);
		
		
		seven_seg_show ((uint8_t) (light_v /150));
	
		P0_data =0x01;
		for (i =0 ; i <8; i++)
		{
			((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->DOUT = (~(P0_data<<i)));

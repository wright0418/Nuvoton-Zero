              ...
              uint32_t u32ChMask)
{
    ...
    ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR = (((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR & (~((1ul << 10) | (3ul << 2)))) |                 u32InputMode |                 u32OpMode;



    ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER = (((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER & ~(0xFFul << 0)) | (u32ChMask);
...
void ADC_Close(ADC_T *adc)
{
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 28);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 28);
    return;
...
void ADC_EnableHWTrigger(ADC_T *adc,
                         ...
                         uint32_t u32Param)
{
    ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR &= ~((3ul << 4) | (3ul << 6) | (1ul << 8));
    if(u32Source == (0UL<<4))
    {
        ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR |= u32Source | u32Param | (1ul << 8);
    }
    else
    {
        ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADTDCR = (((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADTDCR & ~(0xFFul << 0)) | u32Param;
        ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR |= u32Source | (1ul << 8);
    }
    return;
}
...
void ADC_EnableInt(ADC_T *adc, uint32_t u32Mask)
{
    ...
    if(u32Mask & ((1ul << 1)))
        ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCMPR[0] |= (1ul << 1);
    if(u32Mask & ((1ul << 2)))
        ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCMPR[1] |= (1ul << 1);
